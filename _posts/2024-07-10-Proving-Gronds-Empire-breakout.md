...
tags: [MEDIUM, Linux, Samba, SSH, Brute Force, SUDO]
mermaid: true
...
searching the vuln in services
...
login successful with anonymous credentials
...
Petter can execute commands as root
